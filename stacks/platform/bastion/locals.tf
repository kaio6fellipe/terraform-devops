locals {
  ...
  cdirs_acesso_remoto           = try(local.stacks_platform_outputs.cdirs_acesso_remoto, "[null]")
  cdirs_uptime_robot_monitoring = try(local.stacks_platform_outputs.cidrs_uptime_robot_monitoring, "[null]")
}
